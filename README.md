...
![plot of chunk unnamed-chunk-5](./readme/README_files/figure-html/unnamed-chunk-51.png) 

```r
plot_gain(score, label)
```

![plot of chunk unnamed-chunk-5](./readme/README_files/figure-html/unnamed-chunk-52.png) 
